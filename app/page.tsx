...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col">
      <div className="container mx-auto px-4 pt-3 sm:pt-4 pb-0 sm:pb-1 max-w-md flex-1 flex flex-col">
        {/* Header */}
        <div className="text-center mb-0.5 sm:mb-1 flex-shrink-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-1.5 sm:mb-2">
            <span className="block">家庭语音桥</span>
            <span className="block text-2xl sm:text-3xl md:text-4xl text-gray-700 mt-0 sm:mt-0.5">Family Voice Bridge</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 font-medium">
            ...
            <span className="block text-sm sm:text-base md:text-lg text-gray-500 mt-0 font-normal italic">&ldquo;Speak with one tap, learn from practice&rdquo;</span>
          </p>
        </div>
        ...
        <div className="mt-0 flex-shrink-0">
          ...
          <div className="text-center space-y-0.5 sm:space-y-0 sm:space-x-2 flex flex-col sm:flex-row justify-center items-center pb-3 sm:pb-4">
            <Link
              href="/vocabulary"
              className="w-full sm:w-auto inline-block px-4 sm:px-6 py-1.5 sm:py-2 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded-lg transition-colors text-base sm:text-lg shadow-md"
            >
            ...
            <Link
              href="/review"
              className="w-full sm:w-auto inline-block px-4 sm:px-6 py-1.5 sm:py-2 bg-fuchsia-500 hover:bg-fuchsia-600 text-white font-semibold rounded-lg transition-colors text-base sm:text-lg shadow-md"
            >
